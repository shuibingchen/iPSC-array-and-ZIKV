...
pdata=read.table("phenotype_data_ZIKA1.txt",sep = "",row.names = 1)
# load the expression data
edata=read.table("expression_data_ZIKA1.txt",sep = "",row.names = 1)
...
write.csv(RPKM,file = "compare1_RPKM.csv")
...
write.csv(dea1,file = "compare1_mock_DEG.csv")
...
write.csv(dea2,file = "compare1_infect_DEG.csv")
