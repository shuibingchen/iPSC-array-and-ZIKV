...
pdata=read.table("phenotype_data_ZIKA3.txt",sep = "",row.names = 1)
# load the expression data
edata=read.table("expression_data_ZIKA3.txt",sep = "",row.names = 1)
...
write.csv(RPKM,file = "compare3_RPKM.csv")
...
write.csv(dea1,file = "compare3_mock_DEG.csv")
...
write.csv(dea2,file = "compare3_infect_DEG.csv")
