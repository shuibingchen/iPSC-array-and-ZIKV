...
pdata=read.table("phenotype_data_ZIKA4.txt",sep = "",row.names = 1)
# load the expression data
edata=read.table("expression_data_ZIKA4.txt",sep = "",row.names = 1)
...
write.csv(RPKM,file = "compare4_RPKM.csv")
...
write.csv(dea1,file = "compare4_mock_DEG.csv")
...
write.csv(dea2,file = "compare4_infect_DEG.csv")
